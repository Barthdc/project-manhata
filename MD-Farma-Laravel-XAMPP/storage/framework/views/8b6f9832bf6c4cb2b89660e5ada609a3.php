            ...
            <aside>
                <div class="admin-card consult-hero">
                    ...
                    <div class="hero-mini-grid">
                        <div class="hero-mini-card">
                            ...
                            <div class="hero-mini-value"><?php echo e($record->patient->name ?? 'Pasien'); ?></div>
                        </div>

                        <div class="hero-mini-card">
                            <div class="hero-mini-label">Ditangani Oleh</div>
                            <div class="hero-mini-value"><?php echo e($record->staff->name ?? auth()->user()->name ?? 'Admin'); ?></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="admin-card detail-card" style="margin-top: 18px;">
                    <div class="detail-title-row">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->status === 'open'): ?>
                    ...
                    <div class="detail-list">
                        <div class="detail-item">
                            ...
                            <div>
                                ...
                                <div class="detail-value"><?php echo e($record->subject ?? 'Konsultasi Obat'); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="detail-item">
                            ...
                            <div>
                                ...
                                <div id="messageCount" class="detail-value"><?php echo e($record->messages()->count()); ?> pesan tersimpan</div>
                            </div>
                        </div>
                        ...
                        <div class="detail-item">
                            ...
                            <div>
                                ...
                                <div id="lastUpdate" class="detail-value"><?php echo e($record->updated_at?->format('d M Y H:i')); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="topbar-inner">
                        <div class="patient-head">
                            <div class="patient-avatar">
                                <?php echo e(strtoupper(mb_substr($record->patient->name ?? 'P', 0, 1))); ?>

                            </div>

                            <div>
                                <h1>Chat dengan <?php echo e($record->patient->name ?? 'Pasien'); ?></h1>
                ...
                >
                    ...
                    <div id="messageList" class="message-list">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $chatMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            ...
                            <div class="message-row <?php echo e($isMine ? 'mine' : ''); ?>" data-message-id="<?php echo e($msg->id); ?>">
                                <div class="mini-avatar"><?php echo e($initial); ?></div>
                                ...
                                <div class="message-body">
                                    ...
                                    <div class="bubble <?php echo e($isMine ? 'mine' : 'patient'); ?>">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $chatMessages->count()): ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <script>
        ...
        window.mdFarmaAdminChat.boot = function () {
            const conversationId = <?php echo json_encode($record->id, 15, 512) ?>;
            const currentUserId = <?php echo json_encode(auth()->id(), 15, 512) ?>;

            let messageTotal = Number(<?php echo json_encode($record->messages()->count(), 15, 512) ?>);
...
<?php endif; ?>
<?php /**PATH C:\Users\LENOVO\Downloads\MD-Farma-Laravel-XAMPP-PHP83\MD-Farma-Laravel-XAMPP\resources\views/filament/admin/resources/conversations/pages/chat-conversation.blade.php ENDPATH**/ ?>